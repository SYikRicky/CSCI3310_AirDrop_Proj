...
/**
 * Firebase-backed implementation of {@link SharedDriveRepository}.
 *
 * Firebase structure:
 *  Firestore:
 ...
 *  - The Firestore {@code ListenerRegistration} is wrapped in
 *    {@link SharedDriveRepository.Registration} so callers remain decoupled
 *    from the Firebase SDK.
 */
public class FirebaseSharedDriveRepository implements SharedDriveRepository {
    ...
    public FirebaseSharedDriveRepository() {
     ...
     */
    @Override
    public Registration listenToFiles(FilesListener listener) {
        ListenerRegistration firestoreReg = db.collection(COLLECTION)
